...
path_root_N = Path(__file__).parent  / 'Data/Slip/BV_S_Test3.csv'
...
yaw = cumtrapz(gyro_N_z, t_s_N)
test = cumtrapz(yaw, t_s_N[1::])

fig, (Accel, WS) = plt.subplots(2)
Accel.plot(t_s_N[1::], yaw)
# Accel.plot(t_s_N[1::], temp_y_int)
