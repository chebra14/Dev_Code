...
testTraj = 'TestTraj.csv'

with open(testTraj, mode='w', newline='') as file:
    writer = csv.writer(file)

def add_row(csv_data):
    with open(testTraj, mode='a', newline='') as file:
        writer = csv.writer(file)
...
def main():
    ...
    with open('Austria/config_example_map.yaml') as file:
