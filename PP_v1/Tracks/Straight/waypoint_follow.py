...
def straight_Test(flag, startTime):
    speed = 8
    current_Time = (time.time() - startTime)-2

    #Code to change the speed for observation collection
    if(current_Time >= 2): #and current_Time < 2.5):
        speed = 0
    # if(current_Time >= 2.5 and current_Time < 2.8):
    #     speed = 8
    # if(current_Time >= 2.8 and current_Time < 2.9):
    #     speed = 0
    # if(current_Time >= 2.9 and current_Time < 5):
    #     speed = 8
    # if(current_Time >= 5 and current_Time < 5.1):
    #     speed = 0
    # if(current_Time >= 5.1 and current_Time < 6):
    #     speed = 8
    # if(current_Time >= 6):
    #     speed = 0
    #     print("Done")
    ...
    def _get_current_waypoint(self, waypoints, lookahead_distance, position, theta):
        ...
        match self.drive_Mode:
            ...
            case 2:
                ...
                self.flagSpeed, setSpeed = straight_Test(self.flagSpeed, self.start)
...
def main():
    ...
    while not done:
        ...
        #data_csv = [time.time() - start, speed, obs['linear_vels_x'][0]]
        #add_row(data_csv)
        #print(obs)
